...
class Xml_io
{
 ...
 public:
    Xml_io();
    Xml_io(QList<Icon*> icon_list, /*QList<BasicLineObject*> line_list,*/ QString filename, DiagramType diagram_type=(DiagramType)-1 );
    ~Xml_io();
    ...
    ///QList<BasicLineObject*> get_lines() { return m_lines; }
