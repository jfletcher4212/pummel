...
SenarioState::SenarioState(QGraphicsItem *parent) : Icon(parent)
{
    ...
    if (!m_image.load("icons/senarioState.png"))
    ...
    //if (!m_image.load("/Users/mac/Desktop/Rev78-build-desktop-Desktop_Qt_4_7_4_for_GCC__Qt_SDK__Debug/icons/senarioState.png"))
      //  std::cout << "didn't load image properly\n";  //loads the image for drawing later
}

SenarioState::SenarioState(QGraphicsItem *parent, int xsize, int ysize, int xpos, int ypos, QString label) : Icon(parent)
{
    // allows setting of the base rectangle of dragitem
    m_width = xsize;
    m_height = ysize;
...
QRectF SenarioState::boundingRect() const
{
    return QRectF(0,0,m_width, m_height);
}

void SenarioState::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
...
void SenarioState::mouseDoubleClickEvent(QGraphicsSceneMouseEvent *event)
{
    event->accept();
    setValues();
}

void SenarioState::setValues()
{
...
void SenarioState::arrangeBoxes()
{
