...
void solidlineSAH::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    this->setLine(QLineF(interPoint, tempLineOne.p1()));

    double angle = getAngle(interPoint, mySourceReferenceObj);
    ...
    //QPointF arrowP1 = tempLineOne.p1() + QPointF(sin(angle + Pi / 3) * arrowSize, cos(angle + Pi / 3) * arrowSize);
    //QPointF arrowP2 = tempLineOne.p1() + QPointF(sin(angle + Pi - Pi / 3) * arrowSize, cos(angle + Pi - Pi / 3) * arrowSize);

    arrowHead.clear();
    arrowHead << line().p1() << arrowP1 << arrowP2;
    //arrowHead << tempLineOne.p1() << arrowP1 << arrowP2;
...
*/
    ...
    //arrowHead.clear();
    //arrowHead << line().p1() << arrowP1 << arrowP2;
    painter->drawLine(QLineF(interPoint, obj1));
